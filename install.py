...
def _candidate_installers() -> list[Path]:
    ...
    # Workspace sibling (no disk scan): <parent>/repo-mcp-packager/serverinstaller/install.py
...
def main() -> int:
    ...
    # Note: The Activator installer manages the Nexus environment (typically ~/.mcp-tools/.venv).
